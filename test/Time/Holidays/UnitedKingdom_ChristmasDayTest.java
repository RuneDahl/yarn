...
import Time.Holidays.UnitedKingdom.ChristmasDay;
...
/**
 * jUnit test for the class Time.Holidays.UnitedKingdom.ChristmasDay.
 * @author Rune Dahl Iversen
 */
public class UnitedKingdom_ChristmasDayTest {
    ...
    public UnitedKingdom_ChristmasDayTest() { // Intentional
    }

    @BeforeClass
    public static void setUpClass() throws Exception {
        System.out.println("Time.Holidays.UnitedKingdom.ChristmasDay");
    }
