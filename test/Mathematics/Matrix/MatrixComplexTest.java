...
public class MatrixComplexTest {
    ...
    /**
     * Test of addScaledColumn method, of class MatrixComplex.
     */
    @Test
    public void testAddScaledColumn() {
        ...
        int columnToAddTo = 0;
        int columnToAdd = 1;
        Complex scalar = Complex.RealNumber(5.0);
        MatrixComplex instance = this._matrix;
        ...
        values[1][0] = Complex.RealNumber(5.0);
    ...
    /**
     * Test of addScaledColumn method, of class MatrixComplex,
     * for a scalar value of Complex.NaN.
     */
    @Test (expected=IllegalArgumentException.class)
    public void testAddScaledColumn_ScalarNaN() {
        System.out.println("addScaledColumn(to, from, Complex.NaN)");
        int columnToAddTo = 0;
        int columnToAdd = 1;
    ...
    /**
     * Test of addScaledColumn method, of class MatrixComplex,
     * for a scalar value of Complex.Infinity.
     */
    @Test (expected=IllegalArgumentException.class)
    public void testAddScaledColumn_ScalarInfinity() {
        System.out.println("addScaledColumn(to, from, Complex.Infinity)");
        int columnToAddTo = 0;
        int columnToAdd = 1;
    ...
    /**
     * Test of addScaledRow method, of class MatrixComplex.
     */
    @Test
    public void testAddScaledRow() {
        ...
        int rowToAddTo = 0;
        int rowToAdd = 1;
        Complex scalar = Complex.RealNumber(7.0);
        MatrixComplex instance = this._matrix;
        ...
        values[0][1] = Complex.RealNumber(7.0);
        MatrixComplex expResult = new MatrixComplex(values);
        assertEquals(expResult, instance);
    }
    ...
    public void testAddScaledRow_ScalarNaN() {
        System.out.println("addScaledRow(to, from, Complex.NaN)");
        int rowToAddTo = 0;
        int rowToAdd = 1;
        Complex scalar = Complex.NaN;
        MatrixComplex instance = this._matrix;
     ...
     */
    @Test (expected=IllegalArgumentException.class)
    public void testAddScaledRow_ScalarInfinity() {
        System.out.println("addScaledRow(to, from, Complex.Infinity)");
        int rowToAddTo = 0;
        int rowToAdd = 1;
        Complex scalar = Complex.Infinity;
        MatrixComplex instance = this._matrix;
    ...
    /**
     * Test of scaleColumn method, of class MatrixComplex.
     */
    @Test
    public void testScaleColumn() {
        System.out.println("scaleColumn");
        int column = 0;
        Complex scalar = Complex.RealNumber(3.5);
        MatrixComplex instance = this._matrix;
        ...
        for (int r = 0; r < values.length; r++)
            for (int c = 0; c < values[0].length; c++)
                values[r][c] = Complex.Origin;
        for (int col = 0; col < 3; col++) {
            values[col][col] = col == column ? scalar : Complex.RealNumber(1.0);
        }
        Matrix expResult = new MatrixComplex(values);
        assertEquals(expResult, instance);
    }
    ...
    /**
     * Test of scaleColumn method, of class MatrixComplex,
     * for a scalar of value Complex.NaN.
     */
    @Test (expected=IllegalArgumentException.class)
    public void testScaleColumn_ScalarNaN() {
        System.out.println("scaleColumn(c, Complex.NaN)");
        int column = 0;
        Complex scalar = Complex.NaN;
        MatrixComplex instance = this._matrix;
        instance.scaleColumn(column, scalar);
    ...
    /**
     * Test of scaleColumn method, of class MatrixComplex,
     * for a scalar of value Complex.infinity.
     */
    @Test (expected=IllegalArgumentException.class)
    public void testScaleColumn_ScalarInfinity() {
        System.out.println("scaleColumn(c, Complex.Infinity)");
        int column = 0;
        Complex scalar = Complex.Infinity;
        MatrixComplex instance = this._matrix;
        instance.scaleColumn(column, scalar);
    ...
    /**
     * Test of scaleRow method, of class MatrixComplex.
     */
    @Test
    public void testScaleRow() {
        System.out.println("scaleRow");
        int row = 2;
        Complex scalar = Complex.RealNumber(-2.718281828);
        MatrixComplex instance = this._matrix;
        ...
        for (int r = 0; r < values.length; r++)
            for (int c = 0; c < values[0].length; c++)
                values[r][c] = Complex.Origin;
        for (int col = 0; col < 3; col++) {
            values[col][col] = col == row ? scalar : Complex.RealNumber(1.0);
            if (col == row)
            {
                values[row][0] = Complex.RealNumber(-0.0);
                values[row][1] = Complex.RealNumber(-0.0);
            }
        }
        Matrix expResult = new MatrixComplex(values);
        assertEquals(expResult, instance);
    ...
    public void testScaleRow_ScalarNaN() {
        System.out.println("scaleRow(r, Complex.NaN)");
        int row = 2;
        Complex scalar = Complex.NaN;
        MatrixComplex instance = this._matrix;
        instance.scaleRow(row, scalar);
     ...
     */
    @Test (expected=IllegalArgumentException.class)
    public void testScaleRow_ScalarInfinity() {
        System.out.println("scaleRow(r, Complex.Infinity)");
        int row = 2;
        Complex scalar = Complex.Infinity;
        MatrixComplex instance = this._matrix;
        instance.scaleRow(row, scalar);
    ...
    /**
     * Test of switchColumns method, of class MatrixComplex.
     */
    @Test
    ...
    /**
     * Test of switchRows method, of class MatrixComplex.
     */
    @Test
