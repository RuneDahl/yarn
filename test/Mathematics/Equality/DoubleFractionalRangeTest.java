...
/**
 * Test of the class Mathematics.Equality.DoubleFractionalRange.
...
public class DoubleFractionalRangeTest {
    ...
    public DoubleFractionalRangeTest() {
    ...
    @Before
    public void setUp() {
        this._instance = new DoubleFractionalRange(this._defaultPrecision);
    ...
    public void testEqual() {
        System.out.println("DoubleFractionalRange.Equal");
    ...
    public void testGetPrecision() {
        System.out.println("DoubleFractionalRange.getPrecision");
        this._precisionBased.testGetPrecision(_instance, Math.pow(10.0, -10.0));
    }

    @Test
    public void testSetPrecision() {
        System.out.println("DoubleFractionalRange.setPrecision");
