...
/**
 * jUnit test of the class Mathematics.Graph.Tree.IteratorPreOrdered.
 * @author Rune Dahl Iversen
 */
public class IteratorPreOrderedTest {
    private IteratorPreOrdered<Vector<Double>, Vector<Double>> _instance;
    private VectorRealFunctionAndChildren _node;
    private VectorRealFunctionAndChildren[] _childNodes;

    public IteratorPreOrderedTest() { // Intentional
    }
    ...
    public void setUp() {
        ...
        this._instance = new IteratorPreOrdered<Vector<Double>, Vector<Double>>(this._node);
    }
    ...
    /**
     * Test of constructor, of class TreeIteratorPreOrdered, for a null value.
     */
    @Test (expected=NullPointerException.class)
    public void testCtor_Null() {
        System.out.println("IteratorPreOrdered(null)");
        new IteratorPreOrdered<Vector<Double>, Vector<Double>>(null);
    }

    /**
     * Test of hasNext method, of class TreeIteratorPreOrdered.
     */
    @Test
    ...
    /**
     * Test of next method, of class TreeIteratorPreOrdered.
     */
    @Test
    public void testNext() {
        System.out.println("next");
        IteratorPreOrdered<Vector<Double>, Vector<Double>> instance = this._instance;
        Node<Vector<Double>, Vector<Double>> expResult = this._node;
    ...
    /**
     * Test of remove method, of class TreeIteratorPreOrdered.
     */
    @Test (expected=UnsupportedOperationException.class)
    public void testRemove() {
        System.out.println("remove");
        IteratorPreOrdered instance = this._instance;
        instance.remove();
    }
