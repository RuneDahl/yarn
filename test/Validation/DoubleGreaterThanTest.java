...
public class DoubleGreaterThanTest {
    ...
    public void testGetLimit() {
        System.out.println("Testing DoubleGreaterThan.getLimit().");
    ...
    public void testSetLimit() {
        System.out.println("Testing DoubleGreaterThan.setLimit(...).");
    ...
    /**
     * Test of Validate method, of class DoubleGreaterThan.
     */
    @Test
    public void testValidate() {
        System.out.println("Testing DoubleGreaterThan.Validate(...)");
