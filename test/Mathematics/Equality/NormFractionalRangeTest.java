...
/**
 * jUnit-test for the class Mathematics.Equality.NormFractionalRange.
 * @author Rune Dahl Iversen
 */
public class NormFractionalRangeTest {
    private PrecisionBasedTest<Complex> _precisionBased;
    private NormBasedTest _normBased;
    private Norm<Complex> _norm;
    private NormFractionalRange<Complex> _equality;
    private double _precision;
    private Complex _a;
    private Complex _b;

    public NormFractionalRangeTest() { // Intentional
    }

    @BeforeClass
    public static void setUpClass() throws Exception {
        System.out.println("Mathematics.Equality.NormFractionalRange");
    }
    ...
    public void setUp() {
        ...
        this._equality = new Mathematics.Equality.NormFractionalRange<Complex>(
    ...
    /**
     * Test of the protected getMetric method, of class NormFractionalRange.
     */
    @Test
    ...
    /**
     * Test of the getNorm method, of class NormFractionalRange.
     */
    @Test
    ...
    /**
     * Test of the SetNorm method, of class NormFractionalRange.
     */
    @Test
    ...
    /**
     * Test of the SetNorm method, of class NormFractionalRange, for the value null.
     */
    ...
    /**
     * Test of value method, of class NormFractionalRange.
     */
    @Test
    public void testValue() {
        ...
        Complex a = this._a;
        Complex b = this._b;
        NormFractionalRange<Complex> instance = this._equality;
        ...
        a = Complex.Polar(0.0, 0.0);
        b = Complex.RealNumber(0.0);
        result = instance.value(a, b);
        assertEquals(a.toString() + " compared to " + b.toString() + " using " + instance.toString(), expResult, result);
    }

    /**
     * Test of value method, of class NormFractionalRange, for a null value as the first input.
     */
    @Test (expected=NullPointerException.class)
    ...
    /**
     * Test of value method, of class NormFractionalRange, for a null value as the second input.
     */
    @Test (expected=NullPointerException.class)
