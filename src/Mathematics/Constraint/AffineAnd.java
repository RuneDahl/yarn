 ...
 * {@see Double doubles} composed using 'logical and'.
 ...
 * >>= is 'the each and every value in the vector must be greater than
 * or equal to the specified right-hand side value' operator.
 * @author Rune Dahl Iversen
 */
public final class AffineAnd extends Affine {
    /**
     * Creates an instance of an affine and constraint
