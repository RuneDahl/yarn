...
import Time.Holidays.UnitedKingdom.BoxingDay;
...
/**
 * jUnit test for the class Time.Holidays.UnitedKingdom.BoxingDay.
 * @author Rune Dahl Iversen
 */
public class UnitedKingdom_BoxingDayTest {
    private BoxingDay _instance;
    private LinkedList<Integer> _years;
    private HashMap<Integer, GregorianCalendar> _boxingDays;

    public UnitedKingdom_BoxingDayTest() { // Intentional
    }

    @BeforeClass
    public static void setUpClass() throws Exception {
        System.out.println("Time.Holidays.UnitedKingdom.BoxingDay");
    }
