...
/**
 * Implementation of an <a href="http://en.wikipedia.org/wiki/Addition">additive
 * </a> {@see StateShifter shift} in the value of a dimension in a
 * {@see Vector vector} of {@see Double real} values.
 * @author Rune Dahl Iversen
 */
public final class AdditiveDimensionShiftVectorReal
        extends VectorDimensionShiftBased<Double> {
    private final static Validator<Double> __shiftValidator = Factory.FiniteReal();

    /**
     * Creates an instance of the additive shift i nthe value of a dimension in
     * a vector of real values with the specified dimension and shift value.
     * @param dimension Dimension.
     * @param shift     Shift value.
     */
    public AdditiveDimensionShiftVectorReal(
            final int dimension,
            final double shift) {
